...
namespace MagicKit
{
    ...
    /// </summary>
    [RequireComponent(typeof(MagicLeap.Utilities.Placement))]
    public class DodgePlacement : MonoBehaviour
    {
        ...
        [SerializeField, MagicLeapBitMask(typeof(KeyPoseTypes))] private KeyPoseTypes _placementRequestHandPoses;

        // NOTE: In the future this will be repalced with sdk Placement.cs
        private MagicLeap.Utilities.Placement _placement;
        ...
        private void Awake()
        {
            _placement = GetComponent<MagicLeap.Utilities.Placement>();
        }
        ...
        {
            return (_placement.Running && _placement.Fit == MagicLeap.Utilities.FitType.Fits && IsPlacementValid(_placement.Position, _placement.Rotation));
        }
